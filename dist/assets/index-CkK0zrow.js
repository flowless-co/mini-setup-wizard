...
function Zi(e, t, n) {
  ...
  if (t != null)
    ...
    t))
      Gi.call(t, r) && !Ji.hasOwnProperty(r) && (l[r] = t[r]);
 ...
 */ (function (e) {
      ...
      e: for (var W = 0, G = E.length, bn = G >>> 1; W < bn; ) {
        ...
        if (0 > l(gl, z))
          yt < G && 0 > l(er, gl)
            ? ((E[W] = er), (E[yt] = z), (W = yt))
            : ((E[W] = gl), (E[vt] = z), (W = vt));
        else if (yt < G && 0 > l(er, z)) (E[W] = er), (E[yt] = z), (W = yt);
        else break e;
      }
    }
    return P;
  ...
  function w(E, P) {
    (k = !1), S && ((S = !1), d(N), (N = -1)), (g = !0);
    var z = p;
    try {
      for (
        f(P), m = n(s);
        m !== null && (!(m.expirationTime > P) || (E && !Pe()));
      ...
      return (
        ...
        z > W
          ? ((E.sortIndex = z),
            ...
            n(s) === null &&
              E === n(c) &&
              (S ? (d(N), (N = -1)) : (S = !0), yl(v, z - W)))
          : ((E.sortIndex = G), t(s, E), k || g || ((k = !0), vl(w))),
        E
      );
    }),
...
function Uc(e, t, n, r, l, u, o, i, s) {
  (En = !1), (Or = null), Ic.apply(Fc, arguments);
}
...
var Es = ge.unstable_scheduleCallback,
  ...
  Gu = ge.unstable_ImmediatePriority,
...
function qu(e, t, n, r) {
  if (Mr) {
    var l = cu(e, t, n, r);
    if (l === null) Dl(e, t, r, Ir, n), Yo(e, r);
...
var yf = V({}, Jn, {
  ...
  Sf = ke(kf),
  xf = V({}, un, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ef = ke(xf),
  _f = V({}, nl, {
    deltaX: function (e) {
...
function As(e) {
  if (e.propertyName === "value" && rl(Fn)) {
    var t = [];
    Us(t, Fn, e, Xu(e)), ws(Of, t);
  }
}
function jf(e, t, n) {
  e === "focusin"
    ? (ri(), (Cn = t), (Fn = n), Cn.attachEvent("onpropertychange", As))
    : e === "focusout" && ri();
}
function Df(e) {
...
var De = typeof Object.is == "function" ? Object.is : Ff;
function Un(e, t) {
  if (De(e, t)) return !0;
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      rs.forEach(function (n) {
        n !== "selectionchange" && (Bf.has(n) || jl(n, !1, e), jl(n, !0, e));
      });
        ...
        for (var a = c, f; a !== null; ) {
          ...
          if (
            (f.tag === 5 &&
              v !== null &&
              ((f = v),
              d !== null && ((v = jn(a, d)), v != null && S.push(An(a, v, f)))),
            D)
          )
            break;
          a = a.return;
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (S = g, d = k, a = 0, f = S; f; f = Rt(f)) a++;
      ...
      N &&
        (Ms &&
          ...
          (Mt || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && Mt && (C = Ds())
            : ((tt = h),
              (bu = "value" in tt ? tt.value : tt.textContent),
              (Mt = !0))),
        (_ = Fr(c, N)),
        0 < _.length &&
          ((N = new Zo(N, e, null, n, h)),
          m.push({ event: N, listeners: _ }),
          C ? (N.data = C) : ((C = Fs(n)), C !== null && (N.data = C)))),
        (C = Pf ? zf(e, n) : Tf(e, n)) &&
...
function ai(e, t, n, r, l) {
  for (var u = t._reactName, o = []; n !== null && n !== r; ) {
    ...
    i.tag === 5 &&
      ...
      ((i = c),
      l
        ? ((s = jn(n, u)), s != null && o.unshift(An(n, s, i)))
        : l || ((s = jn(n, u)), s != null && o.push(An(n, s, i)))),
      (n = n.return);
  }
...
function ht() {
  if (!Il && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Es(Gu, ht), l);
    } finally {
      (j = t), (Il = !1);
    }
  }
...
function na(e) {
      ...
      : a !== null &&
        (a.elementType === w ||
          (typeof w == "object" &&
            ...
            w.$$typeof === Ze &&
            yi(w) === a.type))
      ? ((v = l(a, f.props)), (v.ref = hn(d, a, f)), (v.return = d), v)
  ...
  function h(d, a, f, v, w) {
    return a === null || a.tag !== 7
      ? ((a = _t(f, d.mode, v, w)), (a.return = d), a)
      : ((a = l(a, f)), (a.return = d), a);
  }
  function m(d, a, f) {
    ...
    if (typeof a == "object" && a !== null) {
      ...
      if (wn(a) || cn(a))
        return (a = _t(a, d.mode, f, null)), (a.return = d), a;
      pr(d, a);
    }
    return null;
  }
  function p(d, a, f, v) {
    ...
    if ((typeof f == "string" && f !== "") || typeof f == "number")
      return w !== null ? null : i(d, a, "" + f, v);
    if (typeof f == "object" && f !== null) {
      switch (f.$$typeof) {
        case nr:
          return f.key === w ? s(d, a, f, v) : null;
        case jt:
          return f.key === w ? c(d, a, f, v) : null;
        case Ze:
          return (w = f._init), p(d, a, w(f._payload), v);
      }
      if (wn(f) || cn(f)) return w !== null ? null : h(d, a, f, v, null);
      pr(d, f);
    }
    return null;
  }
  function g(d, a, f, v, w) {
    if ((typeof v == "string" && v !== "") || typeof v == "number")
      return (d = d.get(f) || null), i(a, d, "" + v, w);
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        case nr:
          return (d = d.get(v.key === null ? f : v.key) || null), s(a, d, v, w);
        case jt:
          return (d = d.get(v.key === null ? f : v.key) || null), c(a, d, v, w);
        case Ze:
          var _ = v._init;
          return g(d, a, f, _(v._payload), w);
      }
      if (wn(v) || cn(v)) return (d = d.get(f) || null), h(a, d, v, w, null);
      pr(a, v);
    }
    return null;
  }
  function k(d, a, f, v) {
    for (
      var w = null, _ = null, C = a, N = (a = 0), H = null;
      C !== null && N < f.length;
      N++
    ) {
      ...
      e && C && O.alternate === null && t(d, C),
        (a = u(O, a, N)),
        _ === null ? (w = O) : (_.sibling = O),
        (_ = O),
        (C = H);
    }
    if (N === f.length) return n(d, C), U && gt(d, N), w;
    if (C === null) {
      for (; N < f.length; N++)
        (C = m(d, f[N], v)),
          C !== null &&
            ((a = u(C, a, N)), _ === null ? (w = C) : (_.sibling = C), (_ = C));
      return U && gt(d, N), w;
    }
  ...
  function S(d, a, f, v) {
    ...
    if (((f = w.call(f)), f == null)) throw Error(y(151));
    for (
      var _ = (w = null), C = a, N = (a = 0), H = null, O = f.next();
      C !== null && !O.done;
      N++, O = f.next()
    ) {
      C.index > N ? ((H = C), (C = null)) : (H = C.sibling);
      var Pe = p(d, C, O.value, v);
      if (Pe === null) {
        C === null && (C = H);
        break;
      }
      e && C && Pe.alternate === null && t(d, C),
        (a = u(Pe, a, N)),
        _ === null ? (w = Pe) : (_.sibling = Pe),
        (_ = Pe),
        (C = H);
    }
    if (O.done) return n(d, C), U && gt(d, N), w;
    if (C === null) {
      for (; !O.done; N++, O = f.next())
        (O = m(d, O.value, v)),
          O !== null &&
            ((a = u(O, a, N)), _ === null ? (w = O) : (_.sibling = O), (_ = O));
      return U && gt(d, N), w;
    }
    for (C = r(d, C); !O.done; N++, O = f.next())
      (O = g(C, d, N, O.value, v)),
        O !== null &&
      ...
      switch (f.$$typeof) {
        case nr:
          e: {
            ...
            f.type === Dt
              ? ((a = _t(f.props.children, d.mode, v, f.key)),
                (a.return = d),
                (d = a))
              : ((v = Tr(f.type, f.key, f.props, null, d.mode, v)),
                (v.ref = hn(d, a, f)),
        ...
        case jt:
          ...
          return o(d);
        case Ze:
          return (_ = f._init), D(d, a, _(f._payload), v);
      }
      if (wn(f)) return k(d, a, f, v);
      if (cn(f)) return S(d, a, f, v);
      pr(d, f);
    }
    return (typeof f == "string" && f !== "") || typeof f == "number"
      ? ((f = "" + f),
        a !== null && a.tag === 6
          ...
          : (n(d, a), (a = Hl(f, d.mode, v)), (a.return = d), (d = a)),
        o(d))
      : n(d, a);
  }
  return D;
...
function Sa(e, t, n) {
  return Pt & 21
    ? (De(n, t) || ((n = Ns()), (A.lanes |= n), (zt |= n), (e.baseState = !0)),
      t)
...
function td(e, t, n) {
  ...
  if (Ea(e)) _a(t, l);
    ...
    (n = la(e, t, l, r)),
      n !== null && ((l = oe()), je(n, e, r, l), Ca(n, t, r));
  }
}
function Ea(e) {
  var t = e.alternate;
...
var Xr = {
  ...
  nd = {
    ...
    useTransition: function () {
      var e = ki(!1),
        t = e[0];
      return (e = bf.bind(null, e[1])), (Ie().memoizedState = e), [t, e];
    },
...
function Eu(e, t, n, r) {
  ...
  typeof u == "object" && u !== null
    ? (l.context = Ce(u))
    : ((u = pe(t) ? Ct : le.current), (l.context = qt(e, u))),
...
function Ti(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null))
    Nr(e, t), Na(t, n, r), Eu(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      i = t.memoizedProps;
    o.props = i;
    ...
    (o.state = p),
      ...
      i !== r || p !== s || de.current || qe
        ? (typeof h == "function" && (xu(t, n, h, r), (s = t.memoizedState)),
    ...
    i !== m || p !== k || de.current || qe
      ? (typeof g == "function" && (xu(t, n, g, r), (k = t.memoizedState)),
        (c = qe || xi(t, n, c, r, p, k, s) || !1)
          ? (h ||
...
function ja(e, t, n) {
  ...
  if (u) {
    ...
    return (
      ...
      i !== null ? (u = ct(i, u)) : ((u = _t(u, o, n, null)), (u.flags |= 2)),
      (u.return = t),
      (r.return = t),
      (r.sibling = u),
      (t.child = r),
        ...
        (e === null || e.child === null) &&
          (dr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Oe !== null && (Fu(Oe), (Oe = null)))),
        Tu(e, t),
        ne(t),
        null
      );
    ...
    case 13:
      if (
        ...
        if (U && ve !== null && t.mode & 1 && !(t.flags & 128))
          ...
          ne(t), (u = !1);
        } else Oe !== null && (Fu(Oe), (Oe = null)), (u = !0);
...
function dd(e, t) {
  ...
  for (mu = { focusedElem: e, selectionRange: n }, Mr = !1, x = t; x !== null; )
          ...
          for (x = l; x !== null; )
            (o = x),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((s.return = o), (x = s))
                : Fi(l);
        for (; u !== null; ) (x = u), Ba(u), (u = u.sibling);
        (x = l), (hr = i), (re = c);
      }
      Mi(e);
    } else
      l.subtreeFlags & 8772 && u !== null ? ((u.return = l), (x = u)) : Mi(e);
  }
}
function Mi(e) {
  for (; x !== null; ) {
...
function me(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Ko(n), t === 1))
      e.tag === 0 ? Jf(Ui.bind(null, e)) : qs(Ui.bind(null, e)),
        Kf(function () {
          !(R & 6) && ht();
        }),
        (n = null);
...
function Ha(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = qr(e, r);
    ...
    R |= 2;
    var u = Qa();
    (Z !== e || b !== t) && ((Ae = null), (rn = Q() + 500), Et(e, t));
    do
      try {
        yd();
        break;
  ...
  if (t !== 0) {
    if (
      (t === 2 && ((l = su(e)), l !== 0 && ((r = l), (t = Iu(e, l)))), t === 1)
    )
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = vu(wt.bind(null, e, ce, Ae), t);
            break;
          }
          wt(e, ce, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = vu(wt.bind(null, e, ce, Ae), r);
            break;
          }
          wt(e, ce, Ae);
          break;
  ...
  return me(e, Q()), e.callbackNode === n ? Ha.bind(null, e) : null;
}
function Iu(e, t) {
  var n = Tn;
  return (
...
function Po() {
  (X === 0 || X === 3 || X === 2) && (X = 4),
    Z === null || (!(zt & 268435455) && !(cl & 268435455)) || et(Z, b);
}
function qr(e, t) {
  var n = R;
  R |= 2;
...
function wt(e, t, n) {
  var r = j,
    l = _e.transition;
  try {
    (_e.transition = null), (j = 1), gd(e, t, n, r);
  } finally {
    (_e.transition = l), (j = r);
  }
  return null;
  ...
  if (nt !== null) {
    ...
    try {
      if (((_e.transition = null), (j = 16 > e ? 16 : e), nt === null))
        ...
        if (((e = nt), (nt = null), (Zr = 0), R & 6)) throw Error(y(331));
        var l = R;
...
Ga = function (e, t, n) {
  ...
  else (fe = !1), U && t.flags & 1048576 && bs(t, Br, t.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Ju(t, n | 1), me(t, Q()), !(R & 6) && ((rn = Q() + 500), ht()));
      }
      break;
    case 13:
      Tt(function () {
...
ys = Co;
gs = Tt;
var zd = { usingClientEntryPoint: !1, Events: [Zn, Ut, ul, hs, vs, Co] },
  yn = {
...
var Od = function (e, t, n, r) {
    ...
    return new (n || (n = Promise))(function (u, o) {
      ...
      function c(h) {
        h.done ? u(h.value) : l(h.value).then(i, s);
      }
        ...
        try {
          ...
          switch (((l = 0), u && (c = [c[0] & 2, u.value]), c[0])) {
            ...
            default:
              ...
              if (c[0] === 6 && n.label < u[1]) {
                (n.label = u[1]), (u = c);
                break;
              }
              if (u && n.label < u[2]) {
                (n.label = u[2]), n.ops.push(c);
                break;
              }
  ...
  var e = this,
    ...
    m = ae.useCallback(function (a) {
      ...
      try {
        ...
        var _ = JSON.stringify(f, null, 2);
        o(_), r(a);
      } catch (C) {
        c((C == null ? void 0 : C.message) || "Failed to parse JSON."), o("");
      }
    }, []),
    p = ae.useCallback(
      function (a) {
        var f,
          v = (f = a.target.files) === null || f === void 0 ? void 0 : f[0];
        if (v) {
          var w = new FileReader();
          (w.onload = function () {
            var _ = String(w.result || "");
            m(_);
          }),
            (w.onerror = function () {
              return c("Unable to read the file.");
            }),
            w.readAsText(v, "utf-8");
        }
      },
      [m]
    ),
    g = ae.useCallback(
      function (a) {
        ...
        a.preventDefault();
        var v =
          (f = a.dataTransfer.files) === null || f === void 0 ? void 0 : f[0];
        if (v) {
          var w = new FileReader();
          (w.onload = function () {
            var _ = String(w.result || "");
    ...
    S = ae.useCallback(
      function () {
        return Od(e, void 0, void 0, function () {
          return Rd(this, function (a) {
            switch (a.label) {
              case 0:
                return u ? [4, navigator.clipboard.writeText(u)] : [2];
              case 1:
                return a.sent(), [2];
            }
          });
    ...
    D = ae.useCallback(
      function () {
        var a = new Blob([u || n], { type: "application/json;charset=utf-8" }),
          f = URL.createObjectURL(a),
          v = document.createElement("a");
        (v.href = f),
          (v.download = u ? "formatted.json" : "input.json"),
          v.click(),
          URL.revokeObjectURL(f);
      },
      [u, n]
    ),
    d = ae.useMemo(function () {
      return T.jsxs("ul", {
        className:
        ...
        children: [
          T.jsxs("li", {
            children: [
              "Drop a ",
              T.jsx("span", { className: "font-medium", children: ".json" }),
              " file here",
            ],
          }),
          T.jsxs("li", {
            children: [
              "or click ",
              T.jsx("span", { className: "font-medium", children: "Browse" }),
              " to pick a file",
            ],
          }),
          T.jsx("li", { children: "or paste JSON directly below" }),
        ],
      });
    }, []);
  return T.jsx("div", {
    ...
    children: T.jsxs("div", {
      ...
      children: [
          ...
          children: [
            T.jsxs("div", {
              ...
              children: [
                    ...
                    T.jsxs("div", {
                      ...
                      children: [
                        T.jsx("button", {
                          onClick: function () {
                            var a;
                            return (a = h.current) === null || a === void 0
                              ? void 0
                              : a.click();
                          },
                          className:
                ...
                T.jsx("div", { className: "mt-4", children: d }),
              ],
            }),
            T.jsxs("div", {
        ...
        T.jsxs("footer", {
          ...
          children: [
            "Tip: This viewer accepts standard JSON or NDJSON (newline‑delimited JSON). Later we’ll add a serializer that converts your input into Django ",
            T.jsx("code", { children: "loaddata" }),
            " fixtures with stable IDs.",
          ],
        }),
      ],
    }),
...
Ql.createRoot(document.getElementById("root")).render(
  T.jsx(gc.StrictMode, { children: T.jsx(jd, {}) })
);
