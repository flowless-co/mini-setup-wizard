...
export default function App() {
    ...
    return (_jsx("div", { className: "min-h-screen w-full bg-gradient-to-b from-gray-50 to-white dark:from-zinc-900 dark:to-zinc-950 text-gray-900 dark:text-gray-100", children: _jsxs("div", { className: "max-w-5xl mx-auto px-4 py-10", children: [_jsx("header", { className: "mb-8", children: _jsxs("div", { className: "flex items-center gap-4 sm:gap-5", children: [_jsx("link", { rel: "icon", type: "image/png", href: "/flowless-icon.png" }), _jsxs("div", { children: [_jsx("h1", { className: "text-3xl sm:text-4xl font-bold tracking-tight", children: "Flowless Setup Wizard \uD83E\uDDD9\u200D\u2642\uFE0F" }), _jsx("p", { className: "mt-2 text-gray-600 dark:text-gray-300", children: "Upload or paste JSON. I\u2019ll pretty-print it in the large text area. Then create content setup" })] })] }) }), _jsxs("section", { className: "grid gap-6", children: [_jsxs("div", { onDragOver: function (e) { return e.preventDefault(); }, onDrop: onDrop, className: "rounded-2xl border border-dashed border-gray-300 dark:border-zinc-700 p-6 sm:p-8 bg-white/70 dark:bg-zinc-900/50 backdrop-blur hover:border-gray-400 transition-colors", children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-lg font-semibold", children: "Upload JSON" }), _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: "Drag & drop or use the file picker." })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("button", { onClick: function () { var _a; return (_a = fileInputRef.current) === null || _a === void 0 ? void 0 : _a.click(); }, className: "px-4 py-2 rounded-xl bg-gray-900 text-white dark:bg-white dark:text-zinc-900 shadow hover:opacity-90", children: "Browse\u2026" }), _jsx("button", { onClick: function () {
                                                    ...
                                                    }, disabled: !rawInput.trim(), className: "px-3 py-1.5 rounded-lg border border-indigo-300 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 disabled:opacity-50", children: "Generate Content Setup" })] })] }), _jsx("textarea", { readOnly: true, value: formatted, placeholder: "Formatted JSON will appear here\u2026", className: "w-full min-h-[50vh] rounded-2xl border border-gray-300 dark:border-zinc-700 bg-white/80 dark:bg-zinc-900/50 p-4 font-mono text-sm tracking-tight" })] })] }), _jsx("footer", { className: "mt-8 text-xs text-gray-500 dark:text-gray-400", children: "Tip: This Wizard accepts standard JSON or NDJSON (newline\u2011delimited JSON)." })] }) }));
}
